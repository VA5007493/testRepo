...
@RestController
public class SonarQubeExporter {

	@SuppressWarnings({ "unchecked", "unused" })
	@RequestMapping(value = "/sonarMetrics", produces = "text/plain")
	public String getSonarMetrics() throws Exception {
		URL url = new URL(
		...
		if (issuesJson != null) {
			...
			int totalPages = 4;//(int) Math.ceil(totalIssues / pageSize);
